        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h3 id="colorlib-logo-15">ครูผู้ช่วย</h3>
              ...
              <h3 id="colorlib-logo-10">สำนักงานเขตพื้นที่การศึกษามัธยมศึกษา เขต 30</h3>
            ...
            <nav id="colorlib-main-menu" role="navigation" className="navbar">
              <div id="navbar" className="collapse">
                <ul>
                  ...
                  <li><a href="#timeline" data-nav-section="timeline">การปฏิบัติงานและกิจกรรมที่เข้าร่วม</a></li>
                  <li><a href="#active" data-nav-section="active">ชั้นเรียนออนไลน์</a></li>
                </ul>
              </div>
            </nav>
            <nav id="colorlib-main-menu">
              <ul>
                <li><a href="https://www.facebook.com/teachcombykrunu" target="_blank" rel="noopener noreferrer"><i className="icon-facebook2" /></a>
