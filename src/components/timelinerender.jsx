          ...
          <div className="timeline-centered">
            ...
            >
              {data.map(obj => {
                ...
                if(lastFour === year){
                  var a = obj.Picture1 + "?auto=compress&cs=tinysrgb&h=350";
                var im1 = obj.Picture1.replace("open?", "uc?");
                var im2 = obj.Picture2.replace("open?", "uc?");
                var im3 = obj.Picture3.replace("open?", "uc?");
                var im4 = obj.Picture4.replace("open?", "uc?");
                var v2 = "inline-block";
                var v3 = "inline-block";
                var v4 = "inline-block";
                if (im2 === null || im2 === "") {
                ...
                return (
                  <div key={obj.ประทับเวลา}>
                    <div className="timeline-entry-inner">
                      <div className="timeline-icon color-5">
                        <i className="icon-pen2" />
                      </div>
                      <div className="timeline-label">
                        <h1 className="btn_titled" style={{ fontSize: "16px" }}>
                          {obj.Title} : วันที่ {firstOne}
                          {parseInt(lastFour) + 543}
                        </h1>
                        <br></br>
                        <div>
                        <h2 style={{paddingTop:10}}>tag:
                          <a href="#">
                            {head1}
                          </a>
                          <a href="#">
